...
public class DKarpov
{
    ...
    {
		if(debug)System.out.println("Initialization Random Box " + DKarpov.VERSION);
    ...
    public void Load(FMLInitializationEvent event)
    {
    	...
    	GameRegistry.addShapelessRecipe(new ItemStack(DKarpov.randombox, 1), new Object[] {DKarpov.keygold, DKarpov.randomboxlock});
    	...
    	GameRegistry.addShapelessRecipe(new ItemStack(DKarpov.randomboxsilver, 1), new Object[] {DKarpov.keysilver, DKarpov.randomboxlocksilver});
    	...
    	GameRegistry.addShapelessRecipe(new ItemStack(DKarpov.randomboxbounty, 1), new Object[] {DKarpov.keybounty, DKarpov.randomboxlockbounty});
    	...
    	GameRegistry.addShapelessRecipe(new ItemStack(DKarpov.randomboxdiamond, 1), new Object[] {DKarpov.keydiamond, DKarpov.randomboxlockdiamond});
